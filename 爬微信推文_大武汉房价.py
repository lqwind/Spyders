# -*- coding: utf-8 -*-
"""
Created on Tue Sep  4 15:29:41 2018
...
if __name__ == '__main__':
    defUrl = 'https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=MzIwOTgwODA4OA==&scene=124&devicetype=android-25&version=26060739&lang=zh_CN&nettype=WIFI&a8scene=3&pass_ticket=1UKSiOjtKvelKDjOSSE71SRnJ%2B1bxDv17d%2FueUCnVMM%3D&wx_header=1'
...
#    defCookies = 'sd_userid=85611532253350994; sd_cookie_crttime=1532253350994; pgv_info=ssid=s9177841282; pgv_pvid=9831643111; rewardsn=; wxtokenkey=777; wxuin=136964955; devicetype=android-25; version=26060739; lang=zh_CN; pass_ticket=1UKSiOjtKvelKDjOSSE71SRnJ+1bxDv17d/ueUCnVMM=; wap_sid2=CNvWp0ESXGJjY21lQUpWdDRBZHB0MjM0OURJcEFQZnU3NjBfWlFRQmxWMlZZcVJwME1MekpjOXJtLWR2SHRTMnpNbTlicmhMSmJneXl6SGE5ZnRfdkJMblY2UWk4d0RBQUF+MKneuNwFOA1AlU4='
    ...
    loadUrl = 'https://mp.weixin.qq.com/mp/profile_ext?action=getmsg&__biz=MzIwOTgwODA4OA==&f=json&offset=170&count=10&is_ok=1&scene=124&uin=777&key=777&pass_ticket=1UKSiOjtKvelKDjOSSE71SRnJ%2B1bxDv17d%2FueUCnVMM%3D&wxtoken=&appmsg_token=972_mugptTknxJISMY%252FTrenC6_J_-0xSWuxtl4qCWQ~~&x5=1&f=json'
